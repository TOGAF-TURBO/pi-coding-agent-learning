/**
 * @fileoverview Session Manager — 基于 JSONL 文件的会话存储和树管理。
 *
 * 会话数据以 JSONL（JSON Lines）格式存储在文件中，每行一个条目。
 * 条目通过 parentId 形成树结构，支持分支和导航。
 * 提供：消息追加、压缩、分支摘要、标签、会话列表/删除、分叉、HTML 导出等。
 */
