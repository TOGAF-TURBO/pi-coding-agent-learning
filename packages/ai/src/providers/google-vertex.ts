/**
 * @fileoverview Google Vertex AI 提供商实现。
 *
 * 通过 Google AI SDK 适配 Vertex AI 上的 Gemini 模型：
 *   - Google Cloud 认证（ADC 默认凭证链）
 *   - 消息格式转换（复用 google-shared.ts）
 *   - 流式响应解析
 *   - 与 google.ts 共享核心逻辑，区别在于认证和端点
 */
