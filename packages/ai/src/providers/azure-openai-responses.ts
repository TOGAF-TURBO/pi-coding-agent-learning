/**
 * @fileoverview Azure OpenAI Responses API 提供商实现。
 *
 * 通过 OpenAI SDK 的 Azure 端点适配 Azure 上的 OpenAI 模型：
 *   - Azure Active Directory 认证
 *   - 消息格式和流式解析（复用 openai-responses-shared.ts）
 *   - Azure 特有的 API 版本和端点配置
 */
