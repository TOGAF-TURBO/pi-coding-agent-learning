...
- [streamSimple](#gear-streamsimple)
- [completeSimple](#gear-completesimple)
...
| Function | Type |
| ---------- | ---------- |
| `stream` | `<TApi extends Api>(model: Model<TApi>, context: Context, options?: ProviderStreamOptions or undefined) => AssistantMessageEventStream` |

Parameters:

* `model`: - 目标模型实例
* `context`: - 对话上下文（系统提示 + 消息历史 + 工具列表）
* `options`: - 流式调用选项（温度、Token 上限、中止信号等）


Returns:

助手消息事件流，可逐事件消费文本/工具调用增量
...
| Function | Type |
| ---------- | ---------- |
| `complete` | `<TApi extends Api>(model: Model<TApi>, context: Context, options?: ProviderStreamOptions or undefined) => Promise<AssistantMessage>` |
...
| Function | Type |
| ---------- | ---------- |
| `streamSimple` | `<TApi extends Api>(model: Model<TApi>, context: Context, options?: SimpleStreamOptions or undefined) => AssistantMessageEventStream` |

Parameters:

* `model`: - 目标模型实例
* `context`: - 对话上下文
* `options`: - 简化选项（含 reasoning 思考级别和 thinkingBudgets Token 预算）
...
| Function | Type |
| ---------- | ---------- |
| `completeSimple` | `<TApi extends Api>(model: Model<TApi>, context: Context, options?: SimpleStreamOptions or undefined) => Promise<AssistantMessage>` |
